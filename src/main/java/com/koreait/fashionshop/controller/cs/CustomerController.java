...
public class CustomerController {
	...
	@RequestMapping(value="/shop/cs/qna/list", method=RequestMethod.GET)
	...
	@RequestMapping(value="/shop/cs/qna/registForm", method=RequestMethod.GET)
	public ModelAndView getRegistForm(HttpServletRequest request) {
		ModelAndView mav = new ModelAndView("shop/cs/registForm");
		
		return mav;
	}
	@RequestMapping(value="/shop/cs/qna/regist", method=RequestMethod.POST)
